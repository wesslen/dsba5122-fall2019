...
<iframe src="../images/slides/07-class/parcoords.html" width="80%" height="80%" frameBorder="0"></iframe>

See the [`parcoords`](http://www.buildingwidgets.com/blog/2015/1/30/week-04-interactive-parallel-coordinates-1) package for demo
...
- PCA introduces a new set of variables (PC's) by **linear combination of the original variables** and standardized (zero mean and unit variance). 

- The PCs are uncorrelated and ordered so that the first component captures the largest possible amount of variation and subsequent components capture increasingly less. 
