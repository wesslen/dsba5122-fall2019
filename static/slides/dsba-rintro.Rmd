...
knitr::include_graphics("../../static/images/slides/dsba-rintro/rstudio.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r9.png")
```
...
knitr::include_graphics("../../static/images/slides/dsba-rintro/r8.png")
```
...
knitr::include_graphics("../../static/images/slides/dsba-rintro/r10.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r11.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r12.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r13.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r14.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r15.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r16.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r17.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../static/images/slides/dsba-rintro/r18.png")
```
...
.  
So urce: [David Robinson](http://varianceexplained.org/r/teach-tidyverse/)
