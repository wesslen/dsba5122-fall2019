...
1. Michael Friendly's Psych 6135: Psychology of Data Visualization [Language of Graphics: Bertin to GoG to `ggplot2`](../../files/LanguageOfGraphics-rw.pdf)^[These slides were modified for this class.]

```{r echo=FALSE}
knitr::include_url('../../files/LanguageOfGraphics-rw.pdf')
```
