...
2. [Shiny enabled `flexdashboard`](https://rmarkdown.rstudio.com/flexdashboard/shiny.html) ^[Best for only inputs and outputs and not complicated reactive statements. If you do, it's better to use `shinydashboard`]^[{-} ![dashboard](/images/class/dashboard.png)]
...
5. [RinteRface](https://rinterface.com/): packages like [`shinydashboardPlus`](https://github.com/RinteRface/shinydashboardPlus),  [`bs4Dash`](https://github.com/RinteRface/bs4Dash),  [`argonDash`](https://rinterface.github.io/argonDash/)

6. Helper functions: [`dragulaR`](https://github.com/zzawadz/dragulaR),  [`shinyWidgets`](https://github.com/dreamRs/shinyWidgets) / [shiny demo](http://shinyapps.dreamrs.fr/shinyWidgets/), and [`waiter`](https://shiny.john-coene.com/waiter/)
