...
- [Reactivity Overview by RStudio](https://shiny.rstudio.com/articles/reactivity-overview.html)
...
2. [Shiny enabled `flexdashboard`](https://rmarkdown.rstudio.com/flexdashboard/shiny.html) ^[Best for only inputs and outputs and not complicated reactive statements. If you do, it's better to use `shinydashboard`]
...
- JJ Alaire's [`flexdashboard` shiny-enabled brushing](https://jjallaire.shinyapps.io/shiny-ggplot2-brushing/)

3. Brusing & interaction:

- John Coene's [`echarts4r`](https://echarts4r.john-coene.com/articles/shiny.html)

- [`crosstalk`](https://rstudio.github.io/crosstalk/using.html) ^[`echarts4r` interactivity is based on `crosstalk`, e.g., see [this brushing/slider tutorial](https://echarts4r.john-coene.com/articles/brush.html).]

- [`plotly`](https://plotly-r.com/linking-views-with-shiny.html): Chapter 15-17 of Carson Sievert's book
...
See `000c-omaayma-shiny-workshop` folder in our Rstudio cloud shiny project.

5. [RinteRface](https://rinterface.com/)
...
- [`shinyWidgets`](https://github.com/dreamRs/shinyWidgets) / [shiny demo](http://shinyapps.dreamrs.fr/shinyWidgets/)
