...
Part 1: Omayma Said's [Intro to the Tidyverse: Data Manipulation using dplyr](https://speakerdeck.com/omaymas/data-manipulation-with-dplyr-first-steps)

Part 2: Garrick Aden Buie's [A Gentle Guide to the Grammar of Graphics
