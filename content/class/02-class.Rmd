...
2. Omayma Said's [Intro to the Tidyverse: Data Manipulation using dplyr](https://speakerdeck.com/omaymas/data-manipulation-with-dplyr-first-steps)

3. Lab: Healy [Chapter 3: "Make a Plot"](http://socviz.co/makeplot.html#makeplot)
