...
![](../../static/images/slides/02-class/dubious1.png)
...
knitr::include_graphics("../../static/images/slides/02-class/dubious2.png")
```
...
```{r out.width = "400px", fig.align="center", echo=FALSE}
knitr::include_graphics("../../static/images/slides/02-class/dubious3.png")
```
...
knitr::include_graphics("../../static/images/slides/02-class/dubious4.png")
```
...
```{r out.width = "500px", fig.align="center", echo=FALSE}
knitr::include_graphics("../../static/images/slides/02-class/dubious5.png")
```
...
knitr::include_graphics("../../static/images/slides/02-class/dubious6.png")
```

---

```{r out.width = "650px", fig.align="center", echo=FALSE}
knitr::include_graphics("../../static/images/slides/02-class/dubious7.png")
```
...
```{r out.width = "650px", fig.align="center", echo=FALSE}
knitr::include_graphics("../../static/images/slides/02-class/dubious8.png")
```
...
```{r out.width = "650px", fig.align="center", echo=FALSE}
knitr::include_graphics("../../static/images/slides/02-class/patternicity.png")
```
