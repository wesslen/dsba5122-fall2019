...
The three books we'll use are:^[Fun fact: all of these books were written in R using [Bookdown](https://bookdown.org/)!]
...
I also highly recommend subscribing to the [R Bloggers](https://www.r-bloggers.com/). This e-mail is sent daily withll of helpful tutorials about how to do stuff with R.
