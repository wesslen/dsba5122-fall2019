...
<span class="newthought">The course textbooks include free online versions.</span> Although I'd still highly recommend buying physical copies (but it's completely optional).

The three books we'll use are:^[Fun fact: all of these books were written in R using [Bookdown](https://bookdown.org/)! Don't believe, here's their code [Healy](https://github.com/kjhealy/socviz), [Wilke](https://github.com/clauswilke/dataviz), and [Wickham](https://github.com/hadley/r4ds).]
...
knitr::kable(grading, "markdown")
```


# Red pandas

[^panda] <span class="newthought">Once you have read</span> this entire syllabus and [the assignments page](/assignments/), please [click here](mailto:rwesslen@uncc.edu) and e-mail me a picture of a red panda. For real. Brownie points if it's animated.
