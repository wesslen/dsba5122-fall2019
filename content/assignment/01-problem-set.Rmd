...
Knit the completed R Markdown file as a html (use the "Knit" button at the top of the script editor window) and compress the entire folder (including the html document, RStudio Project, any respective data, and the R Markdown file). To complete the assignment, [upload here to Canvas]() by 11:59pm on February 4, 2018. You only need to upload once if you work in groups.
