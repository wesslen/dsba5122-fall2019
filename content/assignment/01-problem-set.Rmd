...
For this task, your job will be to create this plot!

![](../../files/problem-set-1/corrupt.pdf)
...
To complete the assignment, [upload your zip file of the folder to Canvas](https://uncc.instructure.com/courses/100065/assignments/516650) by 11:59pm on September 9, 2019. Each person needs to submit their own folder (zip file). (Example: if you work with someone else, you each have to submit your own zip file!)
