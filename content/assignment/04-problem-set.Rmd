...
- [`blogdown` book](https://bookdown.org/yihui/blogdown/). This is a long book and should be used as more of a reference than read from beginning to end. We'll review the first few chapter's through the problem set.
...
To do this follow [these steps](https://alison.rbind.io/post/2019-03-04-hugo-troubleshooting/#netlify-drag-and-drop)
