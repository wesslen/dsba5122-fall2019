...
# Information Visualization & Visual Analytics Courses

- [**CSE 512**](https://courses.cs.washington.edu/courses/cse512/19sp/index.html): [Dr. Jeff Heer](http://jheer.org/)'s University of Washington's graduate Data Visualization course.

- [**PSYC 6135**](http://euclid.psych.yorku.ca/www/psy6135/): [Dr. Michael Friendly](http://www.datavis.ca)'s University of York graduate course in the Psychology of Data Visualization.

- [**CS 7450**](https://www.cc.gatech.edu/~stasko/7450/): [Dr. John Stasko](https://www.cc.gatech.edu/~john.stasko/)'s Georgia Tech graduate Information Visualization course.

- [**CS 4460**](https://www.cc.gatech.edu/~john.stasko/4460/schedule.html): [Dr. John Stasko](https://www.cc.gatech.edu/~john.stasko/)'s Georgia Tech's undergraduate Information Visualization course.

- [**CS 4460**](http://va.gatech.edu/courses/cs4460/): [Dr. Alex Endert](www.endert.org)'s Georgia Tech undergraduate Information Visualization course.

- [**CS 5630** / **CS 6630**](http://dataviscourse.net/2018/index.html): [Dr. Alexander Lex](http://vdl.sci.utah.edu/team/lex/) at Utah University's undergraduate and graduate Visualization for Data Science course.

- [**INLS 641**](https://ils.unc.edu/courses/2017_fall/inls641_001/index.html): [Dr. David Gotz](https://sils.unc.edu/people/faculty/profiles/David-Gotz) at UNC Chapel Hill's graduate course on Visual Analytics
...
- [^r-google][**Stat 545**](http://stat545.com/): [Dr. Jenny Bryan](https://twitter.com/JennyBryan) at the University of British Columbia has an entire introductory course in R, visualization, and data analysis online.
...
- [**Yifu Yan's Resources for webscraping in R**](https://github.com/yusuzech/r-web-scraping-cheat-sheet): This cheat sheet of resources was inspired by Hartley Brody's [similar cheat sheet for web-scraping in Python](https://blog.hartleybrody.com/web-scraping-cheat-sheet/) 
- [**Mike Kearney's `rtweet` package for using the Twitter API to pull Twitter data**](https://rtweet.info/): Mike has created the foremost package (in any language, in my opinion) for using the Twitter API. He has also created a ton of helpful resources including [his incredibly helpful `rtweet` workshop slides](https://rtweet-workshop.mikewk.com/).
...
- [**360Giving**](http://data.threesixtygiving.org/): Dozens of British foundations follow a standard file format for sharing grant data and have made that data available online.
