...
```{r boxplot}
ggplot(df, aes(x = Result_of_Stop, y = Driver_Age)) +
  geom_boxplot()
```
...
**Answer: It appears that the searches were conducted on a slightly younger population than the population that was not searched.**
